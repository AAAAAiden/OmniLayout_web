  ...
  const groundTruthCard = `
    <article class="model-card model-card-reference">
      ...
      <div class="trajectory">
        <img src="gifs/ground-truth.png?v=adafruit-bluefruit-uart-v15" alt="Ground-truth Adafruit Bluefruit LE UART Friend PCB routing with top and bottom layers shown vertically">
      </div>
      ...
      return `
        <article class="model-card">
          ...
          <div class="trajectory">
            ...
            <img data-gif-src="gifs/${activeSetup}--${model.id}.gif?v=adafruit-bluefruit-uart-v15" alt="${model.label} No Tools routing iterations with Net RR and Pin RR metrics baked into each frame" hidden>
          </div>
          <div class="model-card-footer">
